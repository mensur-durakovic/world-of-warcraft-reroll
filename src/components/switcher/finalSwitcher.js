  ...
  return (
    <section className="final-switcher">
      <div className="final-switcher-head">
        <div
          className={`final-switcher-card ${
            !firstOptionActive ? "clickable" : ""
          } `}
        ...
        >
          <div
            className={`${
              firstOptionActive
                ? "final-switcher-card-shadow-active"
                : "final-switcher-card-shadow"
            }`}
          ></div>
          <div
            className={`final-switcher-card-image ${
              !firstOptionActive ? "final-switcher-card-image-gray" : ""
            }`}
          >
          ...
          <div
            className={`${
              firstOptionActive
                ? "final-switcher-card-title-active"
                : "final-switcher-card-title"
            }`}
          >
            {firstOptionTitle}
          </div>
        ...
        >
          ...
          <div
            className={`final-switcher-card-image ${
              !secondOptionActive ? "final-switcher-card-image-gray" : ""
            }`}
          >
          ...
          <div className="final-switcher-body-pickable-head">
            <div className="final-switcher-body-pickable-head-left">
              <div
                className={`${
                  firstOptionActive
                    ? "final-switcher-body-pickable-head-left-vertical-active"
                    : "final-switcher-body-pickable-head-left-vertical"
                }`}
              ></div>
              <div
                className={`${
                  firstOptionActive
                    ? "final-switcher-body-pickable-head-left-horizontal-active"
                    : "final-switcher-body-pickable-head-left-horizontal"
                }`}
              ></div>
            </div>
            <div
            ...
            <div className="final-switcher-body-pickable-head-right">
              <div
                className={`${
                  secondOptionActive
                    ? "final-switcher-body-pickable-head-right-horizontal-active"
                    : "final-switcher-body-pickable-head-right-horizontal"
                }`}
              ></div>
              <div
                className={`${
                  secondOptionActive
                    ? "final-switcher-body-pickable-head-right-vertical-active"
                    : "final-switcher-body-pickable-head-right-vertical"
                }`}
              ></div>
            </div>
          </div>
